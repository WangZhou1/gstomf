...
make
cp *.so ~/project/v57/gds/ES2/bsp4_gst/target/linux/icatchtek/v57/devices/icatch/rootfs/usr/lib/gstreamer-1.0/
cp ./omf/cstream/*.so ~/project/v57/gds/ES2/bsp4_gst/target/linux/icatchtek/v57/devices/icatch/rootfs/usr/lib/ 
#cd ./omf/cstream/ 

 ...
 **/
EXTERNC const char*omfApiVersion();

/** get stream version
 * @return version string
 **/
EXTERNC const char*omfStreamVersion();
 ...
 * @param key the attribute keys,
 * 			ex :br,fr,url...
 * @param ptr of the return val
 * @return attribute value:
 * 			1: success
 * 			0: failed
 **/
EXTERNC int omfAttrGetIntV2(void* hd,const char* key,long long *val);
 ...
 * 			0: failed
 **/
EXTERNC int omfAttrGetBoolV2(void* hd,const char* key, unsigned char* val);
 ...
 * 			0: failed
 **/
EXTERNC int omfAttrGetStrV2(void* hd,const char* key,char** val);
 ...
 * 			0: failed
 **/
EXTERNC int omfAttrGetPtrV2(void* hd,const char* key,void** val);

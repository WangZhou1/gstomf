	...
	namespace api {
		namespace streaming {
			...
			public:
				...
				/**
				 * @brief get the remain samples of the play buffer.
				 * @return simples.
				 */
				virtual int GetRemainSamples() const =0;
				/**
				 * @brief set the live view delay limit table.
				 * @param the limit table
				 * @example	g1={duration=300,speed=1.2},g2={duration=600,speed=1.5}
				 * 			g1/g2    : the group number, support 1~3 groups(g1/g2/g3)
				 * 			duration : the limit duration in play buffer
				 * 			speed    : the audio play speed
				 * @note only the figure can be change, the string format is fixed
				 * @return true or false.
				 */
				virtual bool SetLiveDelayLimit(const char* tab) =0;
				/**
				 * @brief register audio process callback.
				 * @param func	the function callback
				 * @return true.
				 */
				virtual bool RegisterProcessCallback(const FuncFrameRef &func)=0;
			public:///createNew
				/**

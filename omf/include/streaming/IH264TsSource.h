	...
	namespace api {
		namespace streaming {
			...
			public:
				 ...
				 */
				static IH264TsSource* CreateNew(const char *keywords);
				static IH264TsSource* CreateNewFromConfig(const char *config);
				static IH264TsSource* CreateNewFromFile(const char *file);
			};
		}
	}
}

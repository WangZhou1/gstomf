	...
	namespace api {
		namespace streaming {
			...
			public:
				 ...
				 */
				static IAudioTsSource *CreateNew(const char *keywords);
				static IAudioTsSource* CreateNewFromConfig(const char *config);
				static IAudioTsSource* CreateNewFromFile(const char *file);
			public:
				/**
 ...
 */
				static std::vector<TsMediaInfo> GetCapabilities(const char*keywords);

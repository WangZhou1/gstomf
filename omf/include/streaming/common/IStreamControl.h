		...
		namespace streaming {
			namespace common {
				...
				public:
					...
					/**
					 * To compatible V1.1.6 LTS API.
					 * Same as API IsSupportPushFrame.
					 */
					...
					/**
					 * To compatible V1.1.6 LTS API.
					 * Same as API IsSupportInputFrameCallback.
					 */
				...
				public:
					...
					/**
 					 * To compatible V1.1.6 LTS API.
 					 * Same as API IsSupportPullFrame.
 					 */
					...
					/**
					 * To compatible V1.1.6 LTS API.
					 * Same as API IsSupportOutputFrameCallback.
					 */
				...
				public:
					...
					virtual bool OmfRegisterOutputCallback(const FuncFrameRef &func)=0;
				public:
					/**
					 * get the output media info.
					 * @return the output media infomation string.

	...
	namespace api {
		namespace streaming {
			namespace common {
				...
				/**
				 * H264 I/Hevc Frame Structure.
				 */
				typedef struct {
					int vpsOffset=0;///< the VPS NAL offset
					int vpsLenght=0;///< the VPS NAL length
				 ...
				 * Hevc Media info.
				 */
				typedef struct :public H264MediaInfo{
					void* vps=0;///< the VPS data pointer.
					int vpsLength=0;///< the VPS data length.
				} H265MediaInfo;
